...
class HouseControlSystem:
    def __init__(self, Kp=0.5, Ki=0.05, Kd=0.05, setpoint=25):
        ...
        self._thermistor_pins = [analogio.AnalogIn(board.GP27)] # [downstairs, upstairs room 1, upstairs room 2, outside]
    ...
    def set_peltiers_power(self, percentage):
        for peltier in self.peltier_elements:
...
while True:
    ...
    response, error = House.PID_iteration(thermistor_readings[-1])
